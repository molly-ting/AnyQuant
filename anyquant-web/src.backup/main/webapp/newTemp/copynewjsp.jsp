				...
				<div class="social-box facebook card">
					...
					<div class="basicinfo">
						<span id="stockname">沪深300指数&nbsp;&nbsp;</span><span
							id="stockcode">sh000300</span><br /> <span style="float: left;">收盘�?&nbsp;
							(涨跌�?) &nbsp; </span> <span id="closeprice" style="float: left;">
					...
					<ul class="detailinfo">
						<li>�?高价 <span id="high">�?高价</span><br> �?低价 <span
							id="low">�?低价</span>
						</li>
						<li>成交�? <span id="volume">成交�?</span><br> 成交金额 <span
							id="sum">成交金额</span>
						</li>
						<li>市盈�? <span id="pe">市盈�?</span><br> 市净�? <span id="pb">市净�?</span>
						</li>
						<li>ATR <span id="ATR">0</span><br> 乖离�? <span id="gl">0</span>
						</li>
					</ul>
				</div>
					...
					<div class="btn-toolbar pull-right" role="toolbar"
						...
						<div class="btn-group" data-toggle="buttons"
							...
							<label class="btn btn-sm btn-secondary-outline" id="closebtn"
								...
								name="options" id="option1" autocomplete="off">收盘�?
								...
								name="options" id="option3" autocomplete="off">成交�?
							</label>
						</div>
					</div>
				</div>
					...
					<div class="col-md-5" style="padding-top: 0px; padding-bottom: 0px">
						...
						<div class="baraja-demo">
							<ul id="baraja-el" class="baraja-container">
								<li>
									<h4>RBF神经网络模型</h4>
									<p>RBF神经网络模型经过科学研究证明,是世界上�?好的股票分析模型,它�?�度又快,准确度又�?,包你只赔不赚</p>
								...
								<li>
									<h4>灰色模型</h4>
									<p>灰色模型经过科学研究证明,是世界上�?好的股票分析模型,它�?�度又快,准确度又�?,包你只赔不赚</p>
									<h4 style="text-align: center">AnyQuant得分</h4>
						...
						<div class="col-md-4" style="padding-top: 1px">
							<div class="card card-inverse card-danger">
								<div class="card-block">
									...
									<small class="text-muted text-uppercase font-weight-bold">截止2016.7.30,亏损1000�?</small>
									<progress
