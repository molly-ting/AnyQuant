...
public class BoardScrollPane extends BasicScrollBarUI {
	...
	public void setscrollbar() {
		...
		if (this.scrollbar.getOrientation() == JScrollBar.VERTICAL) {
			...
			scrollbar.setPreferredSize(new Dimension(Start.scroll_width / 3, d.height));
			...
			scrollbar.setPreferredSize(new Dimension(d.width, Start.scroll_width / 3));
		}
	...
	public void paintThumb(Graphics g, JComponent c, Rectangle thumbBounds) {
		...
		if (this.scrollbar.getOrientation() == JScrollBar.VERTICAL) {
			tw = Start.scroll_width / 3;
			gp = new GradientPaint(0, 0, color, tw, 0, color);
		} else if (this.scrollbar.getOrientation() == JScrollBar.HORIZONTAL) {
			th = Start.scroll_width / 3;
		...
		g2.fillRoundRect(0, 0, tw, th, Start.gap, Start.gap);
		g2.setColor(color);
