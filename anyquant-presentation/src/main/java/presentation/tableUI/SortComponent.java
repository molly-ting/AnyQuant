...
public class SortComponent {
	...
	private SortBLService sortbl;
	private TableModel tableModel;
	private int[] width;
	private String[] tableheader,options;
	private boolean click = false;

	public SortComponent(JPanel pane, TableModel tModel, int[] width, String[] tableheader, String[] options) {
		sortbl = new Sort();
		tableModel = tModel;
		...
		setupAutoComplete(sorttf, listener);
	...
	private void sort() {
		String[] straname = { "date", "open", "close", "high", "low", "volume" };
		int i = cbInput.getSelectedIndex();
		StrategyVO stravo = new StrategyVO(straname[i]);
		ArrayList<ShareVO> list = tableModel.getList();
		ArrayList<ShareVO> result = sortbl.sort(stravo, list);
	 ...
	 * @param txtInput
	 */
	public void setupAutoComplete(JTextField txtInput, Listener listener) {
