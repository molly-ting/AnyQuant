...
import inteService.apiInteService.GetTopIndustiesService;


public class BasicCrawlController implements GetTopIndustiesService{
	...
	@Override
	public ArrayList<IndustryInfoTop50> getAll() {
		try {
			start();
		} catch (Exception e) {
